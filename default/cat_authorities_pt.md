A seção **Autoridades** do Muscat reúne todos os registros de autoridade, vocabulários controlados e índices. Gostamos de pensar nelas como mini bases de dados no interior do Muscat.
