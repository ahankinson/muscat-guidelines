...
**Requerido si la tonalidad puede ser determinada con certeza.**
...
#### Resumen de plantilla/orgánico (240 $m)
...
<u>*Nota de los traductores sobre la denominación del campo:</u> dado que en Hispanoamérica se presentan diferentes usos regionales para el equivalente castellano a la voz inglesa _scoring_ (entendiéndola como el conjunto de partes vocales e instrumentales implicadas en una composición), se presentan las dos alternativas principales (_plantilla_ para España y Norte y Centro América; _orgánico_ para la región austral del Cono Sur)_._

Ingrese un breve resumen de la plantilla u orgánico que se corresponde con el medio de interpretación general de la obra. Separe cada elemento del resumen con comas. Ingrese un máximo de cuatro elementos. La descripción detallada de la plantilla/orgánico deberá ser registrada en el campo **Plantilla/orgánico total (594)**. El resumen de plantilla/orgánico se escribe en una sola línea. Repita el campo sólo para indicar plantilla/orgánicoes alternativas (ver más abajo).
