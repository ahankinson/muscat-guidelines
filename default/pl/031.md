...
Nie należy umieszczać fragmentów tekstu w nawiasach lub podawać brakujących słów. Pominąć znaki interpunkcyjne i powtórzenia w obrębie incipitu. W tekście nie należy umieszczać znaków interpunkcyjnych i powtórzeń.&nbsp; Akcentów należy używać tylko w takiej formie, w jakiej pojawiają się w słowniku lub jeśli są poprawne gramatycznie. Numery należy wypisać na początku tekstu jako słowa. Upper and lower case letters follow the rules of the respective language, except that designations for God (Herr, Dio, Dieu, Signore, Lord, etc.) always start with a capital letter. W przypadku stosowania incipitu tekstowego jako tytułu ujednoliconego (240), należy upewnić się, że długość i pisownia dokładnie się zgadzają.
